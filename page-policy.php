    ...
    <div class="policy-columns">
      ...
      <div class="policy-columns-box" id="pol-1">
        ...
        <div class="pol-columns-text sa sa--up">
          <div class="top-tit">
            <p>命と財産を守るための<span class="aks">強靱な国づくり</span></p>
          </div>
...
京都南部での被害を未然に防ぐ対策に取り組みます。
          ...
          <div class="pol-columns-point">
            <div>
              <p><span class="aks">平和と安全を守るための</span><span class="aks">防衛体制･経済施策の構築</span></p>
              <p><span class="aks">複雑多様化する犯罪への</span><span class="aks">備えの強化と治安維持</span></p>
              <p class="last"><span class="aks">宇治川･木津川流域の一体的な</span><span class="aks">治水対策の取組み</span></p>
            </div>
          </div>
...
国土軸のハブ拠点には、「ヒト・モノ・カネ・情報」が集まることになります。歴史と伝統が流れる京都南部において、新しい経済の化学反応が無数に誘発されることを応援し、元気な地域経済を取り戻します。「日本全国、世界からも注目される京都南部」の実現、その先に、「日本の再生と成長」があると信じています。
          ...
          <div class="pol-columns-point">
            <div>
              <p><span class="aks">新名神高速道路･北陸新幹線の</span><span class="aks">早期実現への取組み</span></p>
              <p><span class="aks">インフラ整備と連動した</span><span class="aks">積極的な投資への応援</span></p>
              <p class="last"><span class="aks">世界的な競争力を持つ</span><span class="aks">京都南部の構築と</span><span class="aks">日本経済の再生</span></p>
            </div>
          </div>
      ...
      <div class="policy-columns-box" id="pol-3">
        <div class="policy-columns-box-image policy-columns-box-image-3 sa sa--up">
          <div class="pol-columns-tit tit-long sa sa--up">
            <span class="pol-columns-tit-num">
              03
            </span>
        ...
        <div class="pol-columns-text sa sa--up">
          ...
          <div class="pol-columns-point">
            <div>
              <p>食料自給率の向上と<span class="aks">地産地消の推進</span></p>
              <p>「お茶の京都」エリアの<span class="aks">魅力発信強化と</span><span class="aks">交流人口増の取組み</span></p>
              <p>持続可能な地域交通の構築</p>
              <p class="last">過疎地域での暮らしを<span class="aks">応援するための新技術の</span><span class="aks">開発と活用</span></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="policy-columns-box" id="pol-4">
        ...
        <div class="pol-columns-text sa sa--up">
          <div class="top-tit">
            <p>安心して暮らせる<span class="aks">地域社会の構築！</span></p>
          </div>
          ...
          <div class="pol-columns-point">
            <div>
              <p><span class="aks">持続可能で安心な</span><span class="aks">社会保障制度の再構築</span></p>
              <p><span class="aks">子育て世代の声を形に、</span>子育て投資の拡大</p>
              <p><span class="aks">地域･人の絆が生み出す</span><span class="aks">幸福度の高い</span><span class="aks">地域社会の実現</span></p>
              <p class="last"><span class="aks">保育士、介護職員等、</span><span class="aks">医療・福祉現場の処遇改善</span></p>
            </div>
          </div>
      ...
      <div class="policy-columns-box" id="pol-5">
        ...
        <div class="pol-columns-text sa sa--up">
          <div class="top-tit">
            <p><span class="aks">豊かな心の醸成、</span><span class="aks">夢と希望にあふれる人づくり</span></p>
          </div>
          ...
          <div class="pol-columns-point">
            <div>
              <p><span class="aks">保育・幼児教育の充実と</span><span class="aks">子育て世代への支援</span></p>
              <p><span class="aks">教育機会の格差是正、</span><span class="aks">学力格差の解消の取組み</span></p>
              <p class="last"><span class="aks">将来に夢や希望が</span><span class="aks">見いだせる環境づくり</span></p>
            </div>
          </div>
